#pragma once
#ifndef SPARSE_3D_TRILINEAR_PROJECTION_CUDA_KERNELS_H
#define SPARSE_3D_TRILINEAR_PROJECTION_CUDA_KERNELS_H
...
#endif // SPARSE_3D_TRILINEAR_PROJECTION_CUDA_KERNELS_H